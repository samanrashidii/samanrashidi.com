<template>
    <div class="parallax has-shape shape-4-revert white-color center-aligned is-map">
...
var e = new google.maps.Map(document.getElementById("map_canvas"), t, document.getElementById("map_canvas"));
